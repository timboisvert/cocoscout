...
Rails.application.routes.draw do
  ...
  namespace :my do
    ...
    patch  "/time-entries/:id",             to: "time_entries#update",          as: "time_entry"
    delete "/time-entries/:id",             to: "time_entries#destroy"
  ...
  namespace :manage do
    ...
    patch  "/signups/auditions/:production_id/wizard/form_starter/:index", to: "audition_cycle_wizard#update_form_question", as: "signups_auditions_wizard_update_form_question"
    ...
    # Regulars — standing scheduling rules, reviewed and applied week by week.
    post "staffing/scheduling/regulars",          to: "staffing/scheduling_rules#create",  as: "create_staffing_scheduling_rule"
    post "staffing/scheduling/regulars/apply",    to: "staffing/scheduling_rules#apply",   as: "apply_staffing_scheduling_rules"
    patch "staffing/scheduling/regulars/:id",     to: "staffing/scheduling_rules#update",  as: "update_staffing_scheduling_rule"
    ...
    post   "staffing/staff/onboard/details",    to: "staffing/staff_wizard#save_details", as: "save_details_staffing_staff_wizard"
    get    "staffing/staff/onboard/job",        to: "staffing/staff_wizard#job",          as: "job_staffing_staff_wizard"
    post   "staffing/staff/onboard/job",        to: "staffing/staff_wizard#save_job",     as: "save_job_staffing_staff_wizard"
    get    "staffing/staff/onboard/manager",    to: "staffing/staff_wizard#manager",      as: "manager_staffing_staff_wizard"
    ...
    post   "money/payout-runs/funding",      to: "payout_batches#connect_funding",  as: "connect_payout_funding"
    get    "money/payout-runs/funding/return", to: "payout_batches#funding_return", as: "payout_funding_return"
    delete "money/payout-runs/funding",      to: "payout_batches#remove_funding",   as: "remove_payout_funding"
    ...
    resources :contracts, path: "contracts" do
      ...
      member do
        ...
        # same params to apply.
        get "amend/dates", action: :amend_dates, as: :amend_dates
        get "amend/dates/review", action: :review_amend_dates, as: :review_amend_dates
    ...
    post "courses/wizard/instructor",  to: "course_offering_wizard#save_instructor"
    get  "courses/wizard/search_instructor", to: "course_offering_wizard#search_instructor", as: "course_wizard_search_instructor"
    post "courses/wizard/invite_instructor", to: "course_offering_wizard#invite_instructor", as: "course_wizard_invite_instructor"
    get  "courses/wizard/pricing",    to: "course_offering_wizard#pricing",         as: "course_wizard_pricing"
    post "courses/wizard/pricing",    to: "course_offering_wizard#save_pricing"
    get  "courses/wizard/details",    to: "course_offering_wizard#details",         as: "course_wizard_details"
    post "courses/wizard/details",    to: "course_offering_wizard#save_details"
