...
module Manage
  class OrgAvailabilityController < Manage::ManageController
    def index
      ...
      @all_productions = Current.organization.productions
    ...
    def build_person_shows_data(member, end_date)
      ...
      all_shows = []
      @productions ||= Current.organization.productions.to_a
