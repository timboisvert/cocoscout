...
export default class extends Controller {
    ...
    openEditForm(event) {
        ...
        const productionId = event.currentTarget.dataset.productionId

        // Fetch the edit form partial
        fetch(`/manage/productions/${productionId}/audition_sessions/${sessionId}/edit`, {
            headers: {
    ...
    resetForm(event) {
        ...
        fetch(`/manage/productions/${productionId}/audition_sessions/new`, {
            headers: {
                "X-Requested-With": "XMLHttpRequest"
            }
        })
    ...
    refreshSessionsList() {
        ...
        fetch(`/manage/productions/${productionId}/audition_sessions`)
            .then(response => response.text())
            .then(html => {
