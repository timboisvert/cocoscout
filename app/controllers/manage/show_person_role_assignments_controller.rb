...
module Manage
  class ShowPersonRoleAssignmentsController < Manage::ManageController
    ...
    def update
      if @show_person_role_assignment.update(show_person_role_assignment_params)
        redirect_to @show_person_role_assignment, notice: "Show person role assignment was successfully updated",
                                                  status: :see_other
      else
    ...
    def destroy
      ...
      redirect_to show_person_role_assignments_path, notice: "Show person role assignment was successfully deleted",
                                                     status: :see_other
    end
    ...
    def show_person_role_assignment_params
      params.expect(show_person_role_assignment: %i[show_id person_id role_id])
    end
  end
end
