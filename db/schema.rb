...
ActiveRecord::Schema[8.1].define(version: 20_251_206_235_739) do
  ...
  create_table 'audition_cycles', force: :cascade do |t|
    ...
    t.string 'token'
    t.datetime 'updated_at', null: false
    t.index %w[production_id active], name: 'index_audition_cycles_on_production_id_and_active', unique: true,
                                      where: 'active = true'
  ...
  create_table 'audition_email_assignments', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[assignable_type assignable_id audition_cycle_id],
            name: 'index_audition_email_assignments_on_assignable_and_cycle', unique: true
  ...
  create_table 'audition_requests', force: :cascade do |t|
    ...
    t.index %w[requestable_type requestable_id created_at], name: 'index_ar_on_requestable_and_created'
    t.index %w[requestable_type requestable_id],
            name: 'index_audition_requests_on_requestable_type_and_requestable_id'
  end
  ...
  create_table 'auditions', force: :cascade do |t|
    ...
    t.index %w[auditionable_type auditionable_id], name: 'index_auditions_on_auditionable'
  end
  ...
  create_table 'cast_assignment_stages', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[assignable_type assignable_id], name: 'idx_on_assignable_type_assignable_id_366d98058e'
    t.index %w[audition_cycle_id talent_pool_id assignable_type assignable_id],
            name: 'index_cast_assignment_stages_unique', unique: true
  ...
  create_table 'email_drafts', force: :cascade do |t|
    ...
    t.string 'title'
    t.datetime 'updated_at', null: false
    t.index %w[emailable_type emailable_id], name: 'index_email_drafts_on_emailable'
  ...
  create_table 'email_logs', force: :cascade do |t|
    ...
    t.index %w[sent_at user_id], name: 'index_email_logs_on_sent_at_desc_user_id', order: { sent_at: :desc }
  ...
  create_table 'group_memberships', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[group_id person_id], name: 'index_group_memberships_on_group_id_and_person_id', unique: true
  ...
  create_table 'groups_organizations', id: false, force: :cascade do |t|
    ...
    t.index %w[group_id organization_id], name: 'index_groups_organizations_on_group_id_and_organization_id',
                                          unique: true
  ...
  create_table 'organization_roles', force: :cascade do |t|
    ...
    t.index %w[user_id organization_id], name: 'index_organization_roles_on_user_id_and_organization_id',
                                         unique: true
  ...
  create_table 'organizations_people', id: false, force: :cascade do |t|
    t.integer 'organization_id', null: false
    t.integer 'person_id', null: false
    t.index %w[organization_id person_id], name: 'index_organizations_people_on_organization_id_and_person_id'
    t.index %w[person_id organization_id], name: 'index_organizations_people_on_person_id_and_organization_id'
  end
  ...
  create_table 'performance_credits', force: :cascade do |t|
    ...
    t.index %w[profileable_type profileable_id section_name position],
            name: 'index_performance_credits_on_profileable_and_section'
    t.index %w[profileable_type profileable_id], name: 'index_performance_credits_on_profileable'
  end
  ...
  create_table 'performance_sections', force: :cascade do |t|
    ...
    t.string 'profileable_type', null: false
    t.datetime 'updated_at', null: false
    t.index %w[profileable_type profileable_id position],
            name: 'idx_on_profileable_type_profileable_id_position_59d6099064'
    t.index %w[profileable_type profileable_id], name: 'index_performance_sections_on_profileable'
  end
  ...
  create_table 'posters', force: :cascade do |t|
    ...
    t.integer 'production_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[production_id is_primary], name: 'index_posters_on_production_id_primary', unique: true,
  ...
  create_table 'production_permissions', force: :cascade do |t|
    ...
    t.index %w[user_id production_id], name: 'index_production_permissions_on_user_id_and_production_id',
                                       unique: true
  ...
  create_table 'profile_headshots', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[profileable_type profileable_id position],
            name: 'idx_on_profileable_type_profileable_id_position_66776b16f6'
    t.index %w[profileable_type profileable_id], name: 'index_profile_headshots_on_profileable'
  end
  ...
  create_table 'profile_resumes', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[profileable_type profileable_id position],
            name: 'idx_on_profileable_type_profileable_id_position_656777844d'
    t.index %w[profileable_type profileable_id], name: 'index_profile_resumes_on_profileable'
  end
  ...
  create_table 'profile_skills', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[profileable_type profileable_id category skill_name], name: 'index_profile_skills_unique',
                                                                     unique: true
    t.index %w[profileable_type profileable_id], name: 'index_profile_skills_on_profileable'
  end
  ...
  create_table 'profile_videos', force: :cascade do |t|
    ...
    t.index %w[profileable_type profileable_id position],
            name: 'idx_on_profileable_type_profileable_id_position_7b4c262cd5'
    t.index %w[profileable_type profileable_id], name: 'index_profile_videos_on_profileable'
  end
  ...
  create_table 'questionnaire_answers', force: :cascade do |t|
    ...
    t.index %w[questionnaire_response_id question_id], name: 'index_q_answers_on_response_and_question', unique: true
  ...
  create_table 'questionnaire_invitations', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[invitee_type invitee_id questionnaire_id], name: 'index_questionnaire_invitations_unique',
                                                          unique: true
    t.index %w[invitee_type invitee_id], name: 'index_questionnaire_invitations_on_invitee_type_and_invitee_id'
  ...
  create_table 'questionnaire_responses', force: :cascade do |t|
    ...
    t.index %w[respondent_type respondent_id questionnaire_id], name: 'index_questionnaire_responses_unique',
                                                                unique: true
    t.index %w[respondent_type respondent_id], name: 'idx_on_respondent_type_respondent_id_7f07f0f816'
  end
  ...
  create_table 'questionnaires', force: :cascade do |t|
    ...
    t.string 'token', null: false
    t.datetime 'updated_at', null: false
    t.index %w[production_id title], name: 'index_questionnaires_on_production_id_and_title'
  ...
  create_table 'questions', force: :cascade do |t|
    ...
    t.string 'text'
    t.datetime 'updated_at', null: false
    t.index %w[questionable_type questionable_id position], name: 'idx_qstnbl_type_id_pos'
    t.index %w[questionable_type questionable_id], name: 'index_questions_on_questionable'
  end
  ...
  create_table 'shoutouts', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[author_id created_at], name: 'index_shoutouts_on_author_and_created'
    ...
    t.index %w[shoutee_type shoutee_id created_at], name: 'index_shoutouts_on_shoutee_and_created'
    t.index %w[shoutee_type shoutee_id], name: 'index_shoutouts_on_shoutee'
  end
  ...
  create_table 'show_availabilities', force: :cascade do |t|
    ...
    t.integer 'status', default: 0, null: false
    t.datetime 'updated_at', null: false
    t.index %w[available_entity_type available_entity_id show_id], name: 'index_show_availabilities_unique',
                                                                   unique: true
    t.index %w[available_entity_type available_entity_id], name: 'index_show_availabilities_on_entity'
  ...
  create_table 'show_person_role_assignments', force: :cascade do |t|
    ...
    t.integer 'show_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[assignable_type assignable_id], name: 'index_show_role_assignments_on_assignable'
  ...
  create_table 'socials', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[sociable_type sociable_id], name: 'index_socials_on_sociable_type_and_sociable_id'
  end
  ...
  create_table 'talent_pool_memberships', force: :cascade do |t|
    ...
    t.integer 'talent_pool_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[member_type member_id talent_pool_id], name: 'index_tpm_on_member_and_pool'
    t.index %w[member_type member_id], name: 'index_talent_pool_memberships_on_member_type_and_member_id'
    t.index %w[talent_pool_id member_type member_id], name: 'index_talent_pool_memberships_unique', unique: true
  ...
  create_table 'training_credits', force: :cascade do |t|
    ...
    t.integer 'year_end'
    t.integer 'year_start', null: false
    t.index %w[person_id position], name: 'index_training_credits_on_person_id_and_position'
