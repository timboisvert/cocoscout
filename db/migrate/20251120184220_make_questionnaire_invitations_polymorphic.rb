...
class MakeQuestionnaireInvitationsPolymorphic < ActiveRecord::Migration[8.1]
  def up
    ...
    # Add index
    add_index :questionnaire_invitations, %i[invitee_type invitee_id]
    ...
    add_index :questionnaire_invitations, %i[invitee_type invitee_id questionnaire_id], unique: true,
                                                                                        name: 'index_questionnaire_invitations_unique'
  ...
  def down
    ...
    add_index :questionnaire_invitations, %i[questionnaire_id person_id], unique: true,
                                                                          name: 'index_q_invitations_on_questionnaire_and_person'

    # Remove polymorphic columns
    remove_index :questionnaire_invitations, %i[invitee_type invitee_id]
