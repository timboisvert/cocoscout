  ...
  class RolesController < Manage::ManageController
    ...
    def create
      ...
      if @role.save
        ...
        redirect_to manage_casting_settings_section_path(production_id: @production, section: "roles"), notice: "Role was successfully created"
      else
        redirect_to manage_casting_settings_section_path(production_id: @production, section: "roles"), alert: @role.errors.full_messages.join(", ")
      end
    end
    ...
    def update
      ...
      if @role.update(role_params)
        update_eligible_members(@role)
        redirect_to manage_casting_settings_section_path(production_id: @production, section: "roles"), notice: "Role was successfully updated",
                                                               status: :see_other
      else
        redirect_to manage_casting_settings_section_path(production_id: @production, section: "roles"), alert: @role.errors.full_messages.join(", ")
      end
    ...
    def destroy
      @role.destroy!
      redirect_to manage_casting_settings_section_path(production_id: @production, section: "roles"), notice: "Role was successfully deleted", status: :see_other
    end
