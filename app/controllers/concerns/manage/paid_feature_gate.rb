...
module Manage
  ...
  module PaidFeatureGate
    ...
    FEATURE_BY_CONTROLLER = {
      ...
      "manage/money_settings" => :money,
      "manage/show_payouts" => :money,
      "manage/show_financials" => :money,
      "manage/production_expenses" => :money,
      "manage/expense_items" => :money,
      ...
      "manage/contract_appendixes" => :contracts,
      "manage/space_rentals" => :contracts,
