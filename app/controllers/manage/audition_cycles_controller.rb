...
module Manage
  class AuditionCyclesController < Manage::ManageController
    ...
    def destroy
      ...
      redirect_to manage_signups_auditions_path(@production), notice: "Audition Cycle was successfully deleted",
                                                                 status: :see_other
    end
    ...
    def archive
      if @audition_cycle.update(active: false)
        redirect_to manage_signups_auditions_path(@production), notice: "Audition Cycle has been archived",
                                                                   status: :see_other
      else
        redirect_to manage_signups_auditions_path(@production), alert: "Failed to archive Audition Cycle",
                                                                   status: :see_other
      end
    end
