...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl libjemalloc2 sqlite3 libglib2.0-0 libcairo2 libcairo-gobject2 libpoppler-glib8 poppler-utils libgirepository-1.0-1 gir1.2-glib-2.0 gir1.2-poppler-0.18 && \
